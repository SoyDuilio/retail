...
// =============================================
// En el formulario de nueva bodega
...
function validarRucEnTiempoReal() {
    ...
    timeoutValidacionRuc = setTimeout(async () => {
        try {
            ...
            if (data.valido) {
                ...
                document.getElementById('nuevaRazonSocial').value = data.razonSocial;
                document.getElementById('nuevoNombreComercial').value = data.razonSocial;
                document.getElementById('nuevaDireccion').value = data.direccion;
                
                document.getElementById('resultadoValidacionRuc').innerHTML = 
                    '<span class="text-green-400">✓ RUC válido - Datos cargados</span>';
